...
class MPeraturan extends Model
{
	...
	function _get_datatables_query($table, $column_order, $column_search, $order)
	{
		...
		$this->builder->join('tblm_jenisidentifikasi', 'tblm_jenisidentifikasi.idJenisIdentifikasi = tblt_identifikasiperaturan.jenisIdentifikasiId', 'left');
		$this->builder->join('tblt_peraturanrelavan', 'tblt_peraturanrelavan.idPeraturan = tblt_identifikasiperaturan.id');
