            ...
            <table class="table table-sm table-striped table-bordered datatable" id="tabeldata">
                <thead style="font-size:12px;">
                    <tr>
                        ...
                        <th style="width: 15%;">No Urut Dokumen</th>
                        <th style="width: 15%;">No Dokumen</th>
                        <th style="width: 15%;">No Pengesahan</th>
                        <th style="width: 15%;">Nama Peralatan</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        table = $('#tabeldata').DataTable({
            ...
            // "paging": false,
            "ajax": {
                "url": "<?php echo site_url('history/ajax_alat'); ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0],
    ...
    function delete_data(id) {
        swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    url: "<?php echo site_url('history/delete_alat') ?>/" + id,
                    type: "POST",
                    dataType: "JSON",
