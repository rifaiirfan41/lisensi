...
<head>
  ...
  <title>Login E-Lisensi</title>
  <!-- Main styles for this application-->
  <link href="<?= base_url('assets/css/style.css'); ?>" rel="stylesheet">
  <link href="<?= base_url('assets/css/login2.css'); ?>" rel="stylesheet">
...
<body class="c-app flex-row align-items-center" style="background: #0A2C79;">
  <div class="loader">
    <div class="loading">
    </div>
  </div>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-10">
        <div class="card-group">
          <div class="card p-1 d-md-down-none" style="background: #e7e3e3;">
            <div class="card-body" style="background: #0000;">
              <h1 class="text-black mt-2">E-Lisensi Equipment</h1>
	...
	C890.9,218.3,889.8,219.4,888.4,219.4z" />
			...
			L675.3,597.1z" />
                  ...
                  <g>
                    <image href="<?= base_url('assets/img/logo.png') ?>" width="150" x="20%" y="25%" />
                  </g>
                </svg>
              </div>

              <!-- <img src="<?= base_url('assets/img/login.png') ?>" width="100%" height="100%" alt=""> -->
            </div>
          </div>
          <div class="card text-black py-5 rounded" style="width:100%">
            <div class="card-body text-center">
              ...
              <p class="text-muted">PLTU S2P CILACAP</p><?= session('role') ?>
              <form method="POST" action="<?= base_url('login/processlogin') ?>">
                ...
                <div class="row">
                  <div class="col-12">
                    <button class="btn btn-primary" onclick="spinner()" width=" 100%" type="submit">Login</button>
                  </div>
                </div>
              </form>
    ...
    <script>
      ...
      icon.onclick = function() {
        ...
        } else if (inputPass2.getAttribute('type', 'text')) {
