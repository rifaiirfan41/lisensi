    ...
    <div class="card-body table-responsive">
            ...
            <table class="table table-striped table-sm table-bordered datatable" style="font-size:12px;" id="tabeldata">
                <thead>
                    <tr>
                        ...
                        <th style="width: 20%;">JENIS PERATURAN</th>
        ...
        <div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah Jenis Peraturan</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#btn_update').on('click', function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('master/ajax_editjenisperaturan') ?>",
                dataType: "JSON",
                data: {
                    jenis_id: jenis_id,
    ...
    if ($("#ajax_form").length > 0) {
        $("#ajax_form").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: "<?php echo base_url('master/t_jenisperaturan') ?>",
                    type: "POST",
...
<script type="text/javascript">
    $(document).ready(function() {
        table = $('#tabeldata').DataTable({
            ...
            // "paging": false,
            "ajax": {
                "url": "<?php echo site_url('master/ajax_jenisperaturan'); ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0],
    ...
    function delete_data(id) {
        swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    url: "<?php echo site_url('master/delete_jenisperaturan') ?>/" + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data) {
                        Swal.fire({
